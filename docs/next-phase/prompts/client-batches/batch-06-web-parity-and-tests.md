...
> **Status: ✅ complete.** F11 and F12 have landed (`f8ac0de`) — the capability matrix is at
> `../../web-capability-matrix.md` and the parity guard at `test/catalog/web_parity_test.dart`.
> This file is kept as the reference for what was asked for, not as work to do.
