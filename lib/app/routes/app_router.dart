...
final appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
        ...
        builder: (_, __) => _placeholder('OTP Verify')),
    GoRoute(
        path: AppRoutes.projects, builder: (_, __) => _placeholder('Projects')),
    GoRoute(
        path: AppRoutes.createProject,
        builder: (_, __) => _placeholder('Create Project')),
    GoRoute(
        path: AppRoutes.preCapture,
        builder: (_, __) => _placeholder('Pre-Capture')),
    GoRoute(
        path: AppRoutes.permissions,
        builder: (_, __) => _placeholder('Permissions')),
    GoRoute(
        path: AppRoutes.levelAIntro,
        builder: (_, __) => _placeholder('Level A Intro')),
    GoRoute(
        path: AppRoutes.levelACapture,
        builder: (_, __) => _placeholder('Level A Capture')),
    GoRoute(
        path: AppRoutes.levelAReview,
        builder: (_, __) => _placeholder('Level A Review')),
    GoRoute(
        path: AppRoutes.levelBIntro,
        builder: (_, __) => _placeholder('Level B Intro')),
    GoRoute(
        path: AppRoutes.levelBCapture,
        builder: (_, __) => _placeholder('Level B Capture')),
    GoRoute(
        path: AppRoutes.levelBReview,
        builder: (_, __) => _placeholder('Level B Review')),
    GoRoute(
        path: AppRoutes.levelCIntro,
        builder: (_, __) => _placeholder('Level C Intro')),
    GoRoute(
        path: AppRoutes.levelCCapture,
        builder: (_, __) => _placeholder('Level C Capture')),
    GoRoute(
        path: AppRoutes.levelCReview,
        builder: (_, __) => _placeholder('Level C Review')),
    GoRoute(
        path: AppRoutes.captureSummary,
        builder: (_, __) => _placeholder('Capture Summary')),
    GoRoute(
        path: AppRoutes.uploading,
        builder: (_, __) => _placeholder('Uploading')),
    GoRoute(
        path: AppRoutes.processing,
        builder: (_, __) => _placeholder('Processing')),
    GoRoute(
        path: AppRoutes.modelReady,
        builder: (_, __) => _placeholder('Model Ready')),
    GoRoute(
        path: AppRoutes.arPreview,
        builder: (_, __) => _placeholder('AR Preview')),
  ],
);
