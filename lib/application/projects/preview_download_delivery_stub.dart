...
// share sheet) or `dart:js_interop` (web — anchor download of the
// Content-Disposition url). This stub is only reachable on a hypothetical
// platform that has neither library; it fails loudly rather than silently
// no-op-ing.
